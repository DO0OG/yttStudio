...
- [x] **60초 자동 저장, 비정상 종료 복구, 누락 영상 재연결** (§12)
- [x] 검색·치환, 일괄 시간 이동 (코어 + **UI 연결**)
- [x] **설정 UI** — 언어 전환, 스냅 임계값
- [x] **루비 편집 UI + `PC 전용` 호환성 배지** (§5.4, §5.8)
- [x] **로컬라이제이션 — 한국어 / English / 日本語 3개 언어**, UI 문자열 114키 전부
- [x] **§18 배포 전략 확정** — `docs/DEPENDENCIES.md`
...
- [ ] M5 독립 reviewer 검토 — Codex 사용량 소진으로 미실행
