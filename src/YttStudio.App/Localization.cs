...
public sealed class Localizer : System.ComponentModel.INotifyPropertyChanged
{
    ...
    {
        ["MotionPath"] = new("모션 경로", "Motion path", "モーションパス"),
        ["MotionKeyframe"] = new("모션 키프레임", "Motion keyframe", "モーションキーフレーム"),
        ["MotionKeyframeTimeDragUnsupported"] = new("키프레임 시간 이동은 아직 지원하지 않습니다.", "Keyframe time dragging is not supported yet.", "キーフレームの時間ドラッグはまだ対応していません。"),
        ["OpenSubtitle"] = new("자막 열기", "Open Subtitle", "字幕を開く"),
        ["OpenVideo"] = new("영상 열기", "Open Video", "動画を開く"),
        ["OpenVideoUrl"] = new("주소로 열기", "Open by Address", "アドレスで開く"),
        ["OpenVideoUrlTitle"] = new("주소로 열기", "Open by Address", "アドレスで開く"),
        ["OpenVideoUrlPrompt"] = new("YouTube 주소", "YouTube address", "YouTube アドレス"),
        ["OpenVideoUrlPlaceholder"] = new("https://www.youtube.com/watch?v=...", "https://www.youtube.com/watch?v=...", "https://www.youtube.com/watch?v=..."),
        ["OpenVideoUrlConfirm"] = new("열기", "Open", "開く"),
        ["Cancel"] = new("취소", "Cancel", "キャンセル"),
        ["YouTubeUrlInvalid"] = new("YouTube 주소 형식이 올바르지 않습니다.", "The YouTube address format is invalid.", "YouTube アドレスの形式が正しくありません。"),
        ["YouTubeYtDlpMissing"] = new("yt-dlp를 찾을 수 없습니다. 설치 후 다시 시도해 주세요.", "yt-dlp was not found. Install it and try again.", "yt-dlp が見つかりません。インストールしてからもう一度お試しください。"),
        ["YouTubeNetworkFailure"] = new("YouTube 네트워크 연결에 실패했습니다.", "The YouTube network request failed.", "YouTube へのネットワーク接続に失敗しました。"),
        ["YouTubeUnplayable"] = new("이 YouTube 영상은 재생할 수 없습니다. 생방송·연령 제한·비공개·지역 차단 여부를 확인해 주세요.", "This YouTube video cannot be played. Check whether it is live, age-restricted, private, or region-blocked.", "この YouTube 動画は再生できません。ライブ、年齢制限、非公開、地域制限を確認してください。"),
        ["YouTubePlaybackFailed"] = new("YouTube 영상을 재생할 수 없습니다.", "The YouTube video could not be played.", "YouTube 動画を再生できません。"),
        ["YouTubePreflight"] = new("YouTube 영상 정보를 확인하는 중…", "Checking YouTube video information…", "YouTube 動画情報を確認中…"),
        ...
        ["PickColor"] = new("색 고르기", "Pick a colour", "色を選ぶ"),
        ["ColorWhite"] = new("흰색", "White", "白"),
        ["ColorBlack"] = new("검정", "Black", "黒"),
        ["ColorRed"] = new("빨강", "Red", "赤"),
        ["ColorGreen"] = new("초록", "Green", "緑"),
        ["ColorBlue"] = new("파랑", "Blue", "青"),
        ["ColorYellow"] = new("노랑", "Yellow", "黄"),
        ["ColorMagenta"] = new("자홍", "Magenta", "マゼンタ"),
        ["ColorCyan"] = new("청록", "Cyan", "シアン"),
        ...
        ["VideoRenderStopped"] = new("영상 렌더링이 중단되었습니다. 영상을 다시 열어 주세요.", "Video rendering stopped. Please reopen the video.", "映像のレンダリングが停止しました。動画を開き直してください。"),
        ["RemoteVideoPathPrompt"] = new("이 프로젝트의 영상 경로가 이 기기 밖을 가리킵니다. 확인하려면 네트워크에 접속해야 합니다. 계속할까요?", "This project's video path points outside this machine. Checking it requires a network connection. Continue?", "このプロジェクトの動画パスはこの端末の外を指しています。確認にはネットワーク接続が必要です。続けますか？"),
        ["Continue"] = new("계속", "Continue", "続行"),
        ...
        ["CheckForUpdates"] = new("업데이트 확인", "Check for Updates", "更新を確認"),
        ["DownloadUpdate"] = new("업데이트 다운로드 및 설치", "Download and Install Update", "更新をダウンロードしてインストール"),
        ["UpdateChecking"] = new("최신 버전을 확인하는 중…", "Checking for updates…", "更新を確認中…"),
        ["UpdateAvailable"] = new("새 버전 {0}을 사용할 수 있습니다. 다운로드를 선택하세요.", "Version {0} is available. Choose Download Update.", "新しいバージョン {0} を利用できます。「更新をダウンロード」を選択してください。"),
        ["UpdateNotAvailable"] = new("현재 버전 {0}이 최신 버전입니다.", "Version {0} is up to date.", "現在のバージョン {0} は最新です。"),
        ["UpdateNotAvailableShort"] = new("먼저 업데이트를 확인해 주세요.", "Check for updates first.", "先に更新を確認してください。"),
        ["UpdateDownloadPreparing"] = new("업데이트 다운로드를 준비하는 중…", "Preparing the update download…", "更新のダウンロードを準備中…"),
        ["UpdateDownloadProgress"] = new("업데이트 다운로드 중: {0}", "Downloading update: {0}", "更新をダウンロード中: {0}"),
        ["UpdateDownloadBytes"] = new("업데이트 다운로드 중: {0} / {1}바이트", "Downloading update: {0} / {1} bytes", "更新をダウンロード中: {0} / {1} バイト"),
        ["UpdateDownloadCompleted"] = new("업데이트를 다운로드했습니다: {0}", "Update downloaded: {0}", "更新をダウンロードしました: {0}"),
        ["UpdateInstalling"] = new("업데이트를 설치하는 중…", "Installing the update…", "更新をインストール中…"),
        ["UpdateInstallStarted"] = new("업데이트를 시작했습니다. 앱을 다시 여는 중입니다.", "The update has started. The app is restarting.", "更新を開始しました。アプリを再起動しています。"),
        ["UpdateInstallCanceled"] = new("설치가 취소되었습니다.", "Installation was canceled.", "インストールをキャンセルしました。"),
        ["UpdateInstallFailed"] = new("업데이트 설치에 실패했습니다. 기존 설치 상태를 확인할 수 없습니다. 원인: {0}", "The update could not be installed. The state of the existing installation could not be confirmed. Reason: {0}", "更新をインストールできませんでした。既存のインストール状態を確認できません。原因: {0}"),
        ["UpdateInstallUnsupported"] = new("현재 실행 형태에서는 업데이트를 설치할 수 없습니다. 원인: {0}", "This update cannot be installed for the current execution form. Reason: {0}", "現在の実行形態では更新をインストールできません。原因: {0}"),
        ["UpdateInstallInstructions"] = new("자동 설치를 완료하지 못했습니다. 다운로드한 파일을 열어 직접 설치해 주세요.", "Automatic installation did not complete. Open the downloaded file and install it yourself.", "自動インストールを完了できませんでした。ダウンロードしたファイルを開いて手動でインストールしてください。"),
        ["UpdateInstallResultSucceeded"] = new("업데이트 설치가 완료되었습니다.", "The update was installed successfully.", "更新のインストールが完了しました。"),
        ["UpdateInstallResultRolledBack"] = new("업데이트 설치에 실패했지만 기존 설치를 복원하고 다시 실행했습니다. 원인: {0}", "The update failed, but the existing installation was restored and restarted. Reason: {0}", "更新に失敗しましたが、既存のインストールを復元して再起動しました。原因: {0}"),
        ["UpdateInstallResultRestored"] = new("업데이트 설치에 실패했지만 기존 파일은 복원했습니다. 기존 앱을 직접 다시 실행해 주세요. 원인: {0}", "The update failed, but the existing files were restored. Start the existing app manually. Reason: {0}", "更新に失敗しましたが、既存ファイルは復元されました。既存アプリを手動で再起動してください。原因: {0}"),
        ["UpdateInstallResultFailed"] = new("업데이트 설치에 실패했고 기존 설치를 자동 복원하지 못했습니다. 백업 위치: {0}. 원인: {1}", "The update failed and the existing installation could not be restored automatically. Backup location: {0}. Reason: {1}", "更新に失敗し、既存のインストールを自動復元できませんでした。バックアップ場所: {0}。原因: {1}"),
        ["UpdateCheckError"] = new("업데이트 확인 오류", "Update check error", "更新確認エラー"),
        ["UpdateDownloadError"] = new("업데이트 다운로드 오류", "Update download error", "更新ダウンロードエラー"),
        ["UpdateNetworkError"] = new("네트워크 연결에 실패했습니다.", "The network request failed.", "ネットワーク接続に失敗しました。"),
        ["UpdateRateLimited"] = new("업데이트 확인 요청이 제한되었습니다. 잠시 후 다시 시도해 주세요.", "Update checks are rate limited. Try again later.", "更新確認のリクエストが制限されています。しばらくしてから再試行してください。"),
        ["UpdateMetadataError"] = new("릴리스 정보가 올바르지 않습니다.", "The release metadata is invalid.", "リリース情報が正しくありません。"),
        ["UpdateAssetNotFound"] = new("현재 플랫폼용 업데이트 파일을 찾지 못했습니다.", "No update asset was found for this platform.", "このプラットフォーム用の更新ファイルが見つかりません。"),
        ["UpdateUnsupportedPlatform"] = new("현재 플랫폼에서는 업데이트를 지원하지 않습니다.", "Updates are not supported on this platform.", "このプラットフォームでは更新に対応していません。"),
        ["UpdateDownloadFailed"] = new("업데이트 파일을 다운로드하거나 저장하지 못했습니다.", "The update file could not be downloaded or saved.", "更新ファイルをダウンロードまたは保存できませんでした。"),
        ["UpdateUnexpectedError"] = new("예상하지 못한 업데이트 오류가 발생했습니다.", "An unexpected update error occurred.", "予期しない更新エラーが発生しました。"),
        ["UpdateOpenLocationFailed"] = new("파일 위치를 열지 못했습니다. 위 경로에서 파일을 직접 열어 주세요.", "The file location could not be opened. Open the file directly from the path above.", "ファイルの場所を開けませんでした。上のパスからファイルを直接開いてください。"),
